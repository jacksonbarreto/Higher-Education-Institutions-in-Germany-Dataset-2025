...
df = pd.read_excel('eter-export-2021-DE.xlsx')
...
df.loc[df['ETER_ID'] == 'DE0012', 'Url'] = 'www.zeppelin-university.com'

# Change url of DE0143 Hochschule für Musik und Theater München
# Because the url war wrong
df.loc[df['ETER_ID'] == 'DE0143', 'Url'] = 'hmtm.de'

# Change url of DE0346 Deutsche Hochschule für Prävention und Gesundheitsmanagement, Saarbrücken (Priv. FH)
# Because the url war wrong
df.loc[df['ETER_ID'] == 'DE0346', 'Url'] = 'www.dhfpg.de'

# Change url of DE0386 Fachhochschule für Finanzen Brandenburg in Königs Wusterhausen
# Because the url war wrong
df.loc[df['ETER_ID'] == 'DE0386', 'Url'] = 'fhf.brandenburg.de'

# Change url of DE0395 Norddeutsche Hochschule für Rechtspflege, Hildesheim
# Because the url war wrong
df.loc[df['ETER_ID'] == 'DE0395', 'Url'] = 'hr-nord.niedersachsen.de'

# Change url of DE0431 DEKRA Hochschule für Medien
# Because the url war wrong
